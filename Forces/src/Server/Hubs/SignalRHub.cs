...
namespace Forces.Server.Hubs
{
    public class SignalRHub : Hub
    {
        ...
        {
            await Clients.All.SendAsync(ApplicationConstants.SignalR.NotifyOwner);
        }
        public async Task NotifySteppers()
        {
            await Clients.All.SendAsync(ApplicationConstants.SignalR.NotifySteppers);
        }
        public async Task NotifyvCodeControllers()
        {
            await Clients.All.SendAsync(ApplicationConstants.SignalR.NotifyvCodeControllers);
        }
