...
using Forces.Application.Features.Brands.Commands.Delete;
using Forces.Application.Features.Brands.Queries.Export;
...
namespace Forces.Server.Controllers.v1.Catalog
{
    public class BrandsController : BaseApiController<BrandsController>
    {
        ...
        {
            return Ok(await _mediator.Send(new DeleteBinRackCommand { Id = id }));
        }
