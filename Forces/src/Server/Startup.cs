...
using Forces.Server.Extensions;
using Forces.Server.Filters;
using Forces.Server.Helper;
using Forces.Server.Managers.Preferences;
using Forces.Server.Middlewares;
using Hangfire;
...
namespace Forces.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDevexpressServices();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IStringLocalizer<Startup> localizer)
        {
            ...
            provider.Mappings[".repx"] = "application/xml";
            ...
            app.InitializeReports(_configuration);
