        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HouseCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BaseId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BasesSectionsId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Office_BasesSections_BasesSectionsId",
                        column: x => x.BasesSectionsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Inventory_House_HouseId",
                        column: x => x.HouseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Building_BaseId",
                table: "Building",
                column: "BaseId");

            migrationBuilder.CreateIndex(
                name: "IX_House_BaseId",
                table: "House",
                column: "BaseId");

            migrationBuilder.CreateIndex(
                name: "IX_Inventory_BaseSectionId",
                table: "Inventory",
                column: "BaseSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_Inventory_HouseId",
                table: "Inventory",
                column: "HouseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Office_BasesSectionsId",
                table: "Office",
                column: "BasesSectionsId");
