...
namespace Forces.Infrastructure.Migrations
{
    ...
    [Migration("20220402002749_EditRequestsTable")]
    partial class EditRequestsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forces.Application.Models.RequestAttachments<Forces.Infrastructure.Models.VoteCodes, Forces.Infrastructure.Models.Identity.Appuser, Forces.Infrastructure.Models.RequestActions>", b =>
                {
                    ...
                    b.Property<int?>("Requests<VoteCodes, Appuser, RequestActions>Id")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("Requests<VoteCodes, Appuser, RequestActions>Id");
            ...
            modelBuilder.Entity("Forces.Application.Models.RequestAttachments<Forces.Infrastructure.Models.VoteCodes, Forces.Infrastructure.Models.Identity.Appuser, Forces.Infrastructure.Models.RequestActions>", b =>
                {
                    b.HasOne("Forces.Application.Models.Requests<Forces.Infrastructure.Models.VoteCodes, Forces.Infrastructure.Models.Identity.Appuser, Forces.Infrastructure.Models.RequestActions>", null)
                        .WithMany("Attachments")
                        .HasForeignKey("Requests<VoteCodes, Appuser, RequestActions>Id");
                });
