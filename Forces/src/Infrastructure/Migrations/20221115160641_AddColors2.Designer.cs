...
namespace Forces.Infrastructure.Migrations
{
    ...
    [Migration("20221115160641_AddColors2")]
    partial class AddColors2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forces.Application.Models.Vehicle", b =>
                {
                    b.HasOne("Forces.Application.Models.Color", "ColorName")
                        .WithMany("Vehicles")
                        .HasForeignKey("ColorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ColorName");
                });
