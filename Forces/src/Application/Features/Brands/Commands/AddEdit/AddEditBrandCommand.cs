...
namespace Forces.Application.Features.Brands.Commands.AddEdit
{
    public partial class AddEditBrandsCommand : IRequest<Result<int>>
    {
    ...
    internal class AddEditBrandCommandHandler : IRequestHandler<AddEditBrandsCommand, Result<int>>
    {
        ...
        public async Task<Result<int>> Handle(AddEditBrandsCommand command, CancellationToken cancellationToken)
        {
            if (command.Id == 0)
            {
