...
namespace Forces.Application.Features.MprRequest.Query.GetRequests
{
    public class GetRequestsQuery : IRequest<IResult<List<GetMprResponse>>>
    {
        public GetRequestsQuery()
        {
        }
    }
    internal class GetRequestsQueryHandler : IRequestHandler<GetRequestsQuery, IResult<List<GetMprResponse>>>
    {
        ...
        public GetRequestsQueryHandler(IMprRequestRepository repository, IUserService userService, IVoteCodeRepository voteCodeRepository)
        {
        ...
        public async Task<IResult<List<GetMprResponse>>> Handle(GetRequestsQuery request, CancellationToken cancellationToken)
        {
