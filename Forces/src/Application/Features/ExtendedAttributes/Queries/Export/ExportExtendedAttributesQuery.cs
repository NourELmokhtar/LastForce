...
using Forces.Application.Specifications.ExtendedAttribute;
using Forces.Domain.Contracts;
using Forces.Domain.Enums;
...
namespace Forces.Application.Features.ExtendedAttributes.Queries.Export
{
