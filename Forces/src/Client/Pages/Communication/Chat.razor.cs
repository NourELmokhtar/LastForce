...
namespace Forces.Client.Pages.Communication
{
    public partial class Chat
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            HubConnection.On<string>(ApplicationConstants.SignalR.ConnectUser, (userId) =>
            {
                ...
                if (connectedUser is { IsOnline: false })
                {
                    ...
                    _snackBar.Add($"{connectedUser.FirstName} {connectedUser.LastName} {_localizer["Logged In."]}", Severity.Info);
                    StateHasChanged();
                }
            });
            HubConnection.On<string>(ApplicationConstants.SignalR.DisconnectUser, (userId) =>
            {
                ...
                if (disconnectedUser is { IsOnline: true })
                {
                    ...
                    _snackBar.Add($"{disconnectedUser.FirstName} {disconnectedUser.LastName} {_localizer["Logged Out."]}", Severity.Info);
                    StateHasChanged();
                }
            });
        ...
        public void MarkAsRead(string userId)
        {
            ...
            MessagingCenter.Send(this, "MarkAsRead", userId);
        }
        public void UpdateMessages()
        {

            MessagingCenter.Send(this, "NewMessages", "");
        }
        public void MarkAllAsSeen()
        {
            MessagingCenter.Send(this, "MarkAsSeen", "");
        }
        ...
        private async Task GetUsersAsync()
        {
            ...
            var response = await ChatManager.GetChatOUsersAsync();
            if (response.Succeeded)
            {
