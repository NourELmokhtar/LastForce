...
namespace Forces.Client.Pages.Identity
{
    public partial class Profile
    {
        ...
        private UserResponse CurrentUser = new();
        ...
        private async Task LoadDataAsync()
        {
            ...
            var currentUser = await _userManager.GetAsync(UserId);
            ...
            if (CurrentUser.Rank.HasValue)
            {

                RankString = ((RankType)CurrentUser.Rank.Value).ToEnDescriptionString();
            }
        }
