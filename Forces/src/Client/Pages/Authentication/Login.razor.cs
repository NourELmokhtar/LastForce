...
namespace Forces.Client.Pages.Authentication
{
    public partial class Login
    {
        ...
        private void FillForceAdminCredentials()
        {
            _tokenModel.Email = "ForceAdmin1";
            _tokenModel.Password = "@hmed412Magdy";
        }
        private void FillBaseAdminCredentials()
        {
            _tokenModel.Email = "BaseAdmin1";
            _tokenModel.Password = "@hmed412Magdy";
        }
    }
}