...
{
    public partial class AddEditForce
    {
        [Inject] private IForceManager ForceManager { get; set; }

        [Parameter] public AddEditForceCommand AddEditForceModel { get; set; } = new();
        ...
        {
            var response = await ForceManager.SaveAsync(AddEditForceModel);
