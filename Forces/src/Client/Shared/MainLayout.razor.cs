...
using Forces.Client.Infrastructure.Managers.Identity.Roles;
...
namespace Forces.Client.Shared
{
    public partial class MainLayout : IDisposable
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            _drawerOpen = await _clientPreferenceManager.IsDrawerOpen();
        ...
        private async void DrawerToggle()
        {
            ...
            await _clientPreferenceManager.ToggDrawer(_drawerOpen);
        }
