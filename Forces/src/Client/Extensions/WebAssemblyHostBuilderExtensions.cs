...
using Forces.Client.Infrastructure.Authentication;
using Forces.Client.Infrastructure.Managers;
using Forces.Client.Infrastructure.Managers.ExtendedAttribute;
...
namespace Forces.Client.Extensions
{
    public static class WebAssemblyHostBuilderExtensions
    {
        ...
        public static WebAssemblyHostBuilder AddDevexpress(this WebAssemblyHostBuilder builder) 
        {
            builder.Services.AddSingleton(typeof(IDxLocalizationService), typeof(LocalizationService));
            builder.Services.AddSingleton<MprStepTypes>();
